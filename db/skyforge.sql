CREATE DATABASE  IF NOT EXISTS `skyforge` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `skyforge`;
...
--
-- Dumping data for table `forge_items`
--

LOCK TABLES `forge_items` WRITE;
/*!40000 ALTER TABLE `forge_items` DISABLE KEYS */;
INSERT INTO `forge_items` VALUES (1,'Iron Longsword',6.00),(2,'Elven Bow',7.00),(3,'Dwarven Shield',8.00),(4,'Steel Dagger',5.00),(5,'Iron Helmet',6.00),(6,'Leather Chestplate',9.00),(7,'Dwarven Arrow',4.00),(8,'Dragonscale Legs',7.00),(9,'Daedric Boots',5.00);
/*!40000 ALTER TABLE `forge_items` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `forge_items` (`item_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
BEGIN
    ...
    IF (SELECT COUNT(*) FROM forge_items WHERE name = p_item_name) > 0 THEN
...
BEGIN
    ...
    -- Get the item_id and price for the forge item
    SET v_item_id = (SELECT item_id FROM forge_items WHERE name = p_forge_item);
    SET v_price = (SELECT get_price_for_item(p_forge_item));
